      ...
      {adminTab === 'view' && (
        <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
          ...
          <div style={{
            ...
            boxShadow: '0 10px 30px rgba(9, 29, 54, 0.3)',
            border: '1px solid rgba(255, 255, 255, 0.1)'
          }}>
            <div className="bg-grid-overlay" style={{ opacity: 0.15 }} />
            <div style={{ position: 'relative', zIndex: 2 }}>
              <div style={{ display: 'inline-flex', padding: '0.5rem 1rem', borderRadius: '2rem', background: 'rgba(59, 130, 246, 0.2)', color: '#60a5fa', fontSize: '0.8rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', gap: '0.5rem', alignItems: 'center', marginBottom: '1.5rem' }}>
                <Sparkles size={14} /> Explore Coimbatore
              </div>
              <h2 style={{ fontSize: '3rem', fontWeight: 800, color: 'white', margin: 0, textTransform: 'uppercase', letterSpacing: '0.02em', fontFamily: 'var(--font-heading)' }}>
          ...
          <div className="glass-card" style={{ marginBottom: '4rem', padding: '2.5rem', textAlign: 'left' }}>
            <h3 style={{ fontSize: '1.75rem', color: 'white', marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.75rem', fontWeight: 800 }}>
              <BookOpen size={24} className="text-blue-400" /> About Coimbatore
            </h3>
            ...
            <div style={{
              ...
              <p style={{ color: 'white', fontSize: '1rem', fontWeight: 600, margin: 0, lineHeight: '1.6' }}>
          ...
          {touristPlaces.length > 0 && (
            <div style={{ marginBottom: '5rem' }}>
              <h3 style={{ fontSize: '2rem', color: 'white', fontWeight: 800, marginBottom: '2.5rem', textAlign: 'left', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', paddingBottom: '1rem' }}>
                    ...
                    <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
                      <span
                        ...
                        style={{
                          ...
                          marginBottom: '1rem',
                          background: place.category.toLowerCase().includes('religious') ? 'rgba(245, 158, 11, 0.15)' : place.category.toLowerCase().includes('nature') ? 'rgba(16, 185, 129, 0.15)' : 'rgba(59, 130, 246, 0.15)',
                          color: place.category.toLowerCase().includes('religious') ? '#fbbf24' : place.category.toLowerCase().includes('nature') ? '#34d399' : '#60a5fa'
                        }}
                      >
                        {place.category}
                      </span>
                      <h4 style={{ fontSize: '1.25rem', color: 'white', fontWeight: 700, margin: '0 0 0.75rem', lineHeight: '1.4' }}>{place.name}</h4>
                      <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.6, flex: 1 }}>
                        {place.description}
                      </p>
                      <a
                      ...
                      >
                        <ExternalLink size={16} style={{ color: '#0f52ba' }} /> View Direction
                      </a>
                    </div>
                  </motion.div>
                ))}
                    ...
                    <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
                      <span
                        ...
                        style={{
                          ...
                          letterSpacing: '0.05em',
                          marginBottom: '1rem',
                          background: stay.category.toLowerCase().includes('hill') ? 'rgba(139, 92, 246, 0.15)' : 'rgba(16, 185, 129, 0.15)',
                          color: stay.category.toLowerCase().includes('hill') ? '#a78bfa' : '#34d399'
                        }}
                      >
                        {stay.category}
                      </span>
                      <h4 style={{ fontSize: '1.25rem', color: 'white', fontWeight: 700, margin: '0 0 0.75rem', lineHeight: '1.4' }}>{stay.name}</h4>
                      <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.6, flex: 1 }}>
                        {stay.description}
                      </p>
                      <a
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
                {['Luxury Hotels', 'Mid-Range Hotels', 'Budget-Friendly Hotels'].map((catName) => {
                  ...
                  const isLuxury = catName.includes('Luxury');
                  const isMid = catName.includes('Mid');

                  return (
                    <div key={catName}>
                      <h3 style={{ fontSize: '1.75rem', color: '#091d36', marginBottom: '2rem', textAlign: 'left', display: 'flex', alignItems: 'center', gap: '0.75rem', fontWeight: 800 }}>
                        <span
                          style={{
                            fontSize: '0.8rem',
                            padding: '0.4rem 1rem',
                            borderRadius: '2rem',
                            color: 'white',
                            background: isLuxury ? '#091d36' : isMid ? '#0f52ba' : '#0ea5e9'
                          }}
                        >
                          {catName}
                        </span>
                        ...
                        {catHotels.map((hotel, hidx) => (
                          ...
                          >
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              style={{ display: 'block', width: '100%', height: '180px', overflow: 'hidden', position: 'relative' }}
                              title="Click to view full image"
                            >
                              <img
                            ...
                            <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
                              <h4 style={{ fontSize: '1.3rem', color: '#0f172a', fontWeight: 800, margin: '0 0 0.5rem' }}>{hotel.name}</h4>
                              ...
                              <p style={{ fontSize: '0.95rem', color: '#475569', lineHeight: 1.6, margin: '0 0 1.5rem', flex: 1 }}>
                                {hotel.description}
                              </p>
                              <a
